...
class CPDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        im_parse = transforms.Resize(192, interpolation=0)(im_parse)
        ...
        # output_img = Image.fromarray(np.asarray(parse_head, dtype=np.uint8))
        # savepath = im_name+'.png'
